...
export default () => {
  ...
  .reply(200, [{"retrievalId":"someId","directDeepLink":"https://lcw.app/request.html?issuer=issuer.example.com&auth_type=bearer&challenge=89d54819-9439-4ca0-b2d9-a670143e58fb&vc_request_url=http://localhost:4005/exchange/1b6843f2-9b3f-4553-a8bc-cfd41b1e7f12/89d54819-9439-4ca0-b2d9-a670143e58fb","vprDeepLink":"https://lcw.app/request.html?issuer=issuer.example.com&auth_type=bearer&vc_request_url=http://localhost:4005/exchange/1b6843f2-9b3f-4553-a8bc-cfd41b1e7f12","chapiVPR":{"query":{"type":"DIDAuthentication"},"interact":{"service":[{"type":"VerifiableCredentialApiExchangeService","serviceEndpoint":"http://localhost:4005/exchange/1b6843f2-9b3f-4553-a8bc-cfd41b1e7f12/89d54819-9439-4ca0-b2d9-a670143e58fb"},{"type":"CredentialHandlerService"}]},"challenge":"89d54819-9439-4ca0-b2d9-a670143e58fb","domain":"http://localhost:4005"}}], [
  'X-Powered-By',
  'Express',
  ...
  '825',
  'ETag',
  'W/"339-+dnDN3kOeMxStP1t3L4sltTLjsA"',
  'Date',
  'Mon, 11 Sep 2023 18:32:43 GMT',
  'Connection',
  'keep-alive',
  'Keep-Alive',
  'timeout=5'
