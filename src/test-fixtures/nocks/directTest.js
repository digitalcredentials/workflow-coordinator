...
const signedVcWithId = {
  ...
  "name": "A Simply Wonderful Course",
  "proof": {
    "created": "2023-09-11T18:39:02Z",
    "proofPurpose": "assertionMethod",
    "proofValue": "z4J4QCmsJBBeC3kTY9rBDQMJCfz7p8ZZ5ELEbiDcY5z2EHzedF1kdDKthdhrzvindUhg3A4Z9Bs9tTX1hQ7gzTwo7",
...
const signedVp = {
  ...
  "holder": "did:ex:223234",
  "proof": {
    "type": "Ed25519Signature2020",
    "created": /.+/i,
    "verificationMethod": "did:key:z6MkvL5yVCgPhYvQwSoSRQou6k6ZGfD5mNM57HKxufEXwfnP#z6MkvL5yVCgPhYvQwSoSRQou6k6ZGfD5mNM57HKxufEXwfnP",
...
export default () => {
  ...
  .post('/exchange', {
    ...
    "data": [{ "vc": unsignedVc, "retrievalId": "someId" }],
...
nock('http://localhost:4004', { encodedQueryParams: true })
  .post('/exchange/8c6f8343-e82b-48a2-b81e-3c9e0d596238/9374011d-2b48-4416-a7a8-ea7a50b155a8', signedVp)
  .reply(200, {
    "vc": unsignedVc,
    "retrievalId": "someId",
    "tenantName": "UN_PROTECTED_TEST",
    "exchangeHost": "http://localhost:4005",
    "transactionId": "9374011d-2b48-4416-a7a8-ea7a50b155a8",
    "exchangeId": "8c6f8343-e82b-48a2-b81e-3c9e0d596238"
  }, [
  'X-Powered-By',
  'Express',
  'Access-Control-Allow-Origin',
...
nock('http://localhost:4006', { encodedQueryParams: true })
  .post('/instance/un_protected_test/credentials/sign', unsignedVcWithId)
  .reply(200, signedVcWithId, [
  'X-Powered-By',
  'Express',
  'Access-Control-Allow-Origin',
  '*',
...
nock('http://localhost:4004', { encodedQueryParams: true })
  ...
  .reply(200, [
    {
      "type":"directDeepLink",
      "url":"https://lcw.app/request.html?issuer=issuer.example.com&auth_type=bearer&challenge=3bc9dc5e-c949-4d1d-872e-e96797f49959&vc_request_url=http://localhost:4005/exchange/e8caa01f-3804-4fbf-a25c-3fbf280ca902/3bc9dc5e-c949-4d1d-872e-e96797f49959"
    },
    {
      "type": "vprDeepLink",
      "url":"https://lcw.app/request.html?issuer=issuer.example.com&auth_type=bearer&vc_request_url=http://localhost:4005/exchange/e8caa01f-3804-4fbf-a25c-3fbf280ca902"
    }
  ], [
  'X-Powered-By',
  'Express',
...
// that we generate as part of the test
nock('http://localhost:4004', { encodedQueryParams: true })
  .post('/exchange/e8caa01f-3804-4fbf-a25c-3fbf280ca902/3bc9dc5e-c949-4d1d-872e-e96797f49959', signedVp)
  .reply(200, {
    "vc": unsignedVc,
    "tenantName": "UN_PROTECTED_TEST",
    "exchangeHost": "http://localhost:4005",
    "transactionId": "3bc9dc5e-c949-4d1d-872e-e96797f49959",
    "exchangeId": "e8caa01f-3804-4fbf-a25c-3fbf280ca902"
  }, [
  'X-Powered-By',
  'Express',
  'Access-Control-Allow-Origin',
